...
from app.models.schemas import ExecutionState
...
class StateManager:
    ...
    def __init__(self):
        ...
        self._initial_state: Optional[ExecutionState] = None
    ...
    def step(self) -> Optional[ExecutionState]:
        """
        ...
        changed_registers = self._detect_changed_registers(
            prev_state.registers.values,
            current_state.registers.values
        )
    ...
    def _detect_changed_registers(
        ...
        """
        from app.models.schemas import MIPS_REGISTERS
    ...
    def reset(self) -> Optional[ExecutionState]:
        """
